...
export default function Index() {
    ...
    const handleDelete = async (id: number) => {
        ...
        try {
            ...
            const response = await fetch(`/ration-voucher-categories/${id}`, {
                method: 'DELETE',
    ...
    useEffect(() => {
        fetch('/ration-voucher-categories-list')
            .then((response) => {
                if (!response.ok) {
    ...
    return (
        <>
            <Head title="Ration voucher category management" />
                ...
                <div className="rounded-2xl border border-slate-200 bg-white px-6 py-5 shadow-sm dark:bg-black dark:border-sky-950">
                    <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                        <div>
                            ...
                            <h1 className="mt-1 text-2xl font-semibold text-slate-900 dark:text-slate-100">Ration voucher category management</h1>
                        </div>

                        <Link
                            href="/ration-voucher-categories/create"
                                        ...
                                        <tr key={data.id} className="transition dark:hover:bg-slate-900 hover:bg-slate-50">
                                            ...
                                            <td className="border-b dark:border-sky-950 border-slate-200 px-4 py-3">
                                                <div className="flex items-center justify-center gap-2">
                                                    <Link
                                                        href={`/ration-voucher-categories/${data.id}/edit`}
...
Index.layout = {
    breadcrumbs: [
        {
            title: 'Ration voucher category management',
